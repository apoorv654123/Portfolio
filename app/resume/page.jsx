...
const about = {
  title: "About me",
  description:
    "I am a passionate web developer with a focus on creating dynamic and responsive web applications. I have experience in both front-end and back-end development, and I enjoy working with modern technologies to build efficient and scalable solutions.",
  info: [
    {
      fieldName: "Name",
      fieldValue: "Apoorv",
    ...
    {
      fieldName: "Email",
      fieldValue: "apoorv654123@gmail.com",
    },
    {
...
const education = {
  ...
  title: "My Education",
  description:
    "I have a solid educational background that has equipped me with the necessary skills to excel in web development.",
  items: [
    {
                        ...
                        <TooltipProvider delayDuration={100}>
                          <Tooltip>
                            <TooltipTrigger className="w-full h-[150px] bg-[#232329] rounded-xl flex items-center justify-center group">
                              <div className="text-6xl group-hover:text-accent transition-all dduration-300">
                                {skill.icon}
                              </div>
                            </TooltipTrigger>
                            <TooltipContent>
